...
const ProductsData = ({ loadData, cart, setCart }) => {
    ...
    <div className="w-10/12 mx-auto mb-20">
      <div className="text-center space-y-2 max-w-2xl mx-auto mb-10">
        ...
        <p className="text-neutral-500 font-semibold text-base md:text-lg">
          ...
          enhance your productivity and creativity. From AI-powered software to
          design assets, our platform offers a wide range of resources to help
